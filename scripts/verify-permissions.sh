...
echo "ℹ️  This checks terminal/ffmpeg microphone permission (Ghostty/iTerm/Terminal), not just MiloOverlay.app"
echo ""
...
echo "4. Build a fresh MiloOverlay.app so it appears explicitly:"
echo "   ./scripts/install-app.sh"
echo "5. Launch it once:"
echo "   open -a \"$HOME/Desktop/MiloOverlay.app\""
echo ""
